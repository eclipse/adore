...
public:
    ...
    SetPointRequestSwath(double l,double w,double p,double lat_precision,double lat_error=0.0,double lon_error=0.0)
        :l_(l),w_(w),p_(p),lat_precision_(lat_precision),lat_error_(lat_error),lon_error_(lon_error){}
     ...
     */
    void append_cylinder_swath_linear(const SetPointRequest& spr, adore::mad::OccupancyCylinderTree& prediction)
    {
