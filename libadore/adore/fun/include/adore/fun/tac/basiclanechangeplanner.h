      ...
      public:
        ...
        BasicLaneChangePlanner(   adore::view::ALaneChangeView* lcv,
              ...
              : DecoupledLFLCPlanner<K,P>(lcv->getTargetLane(),plon,plat,pveh,ptrajectory),
                ...
                lfvSpeedLimit_(lcv->getTargetLane(),ptac),
                dontDriveBackwards_(),
                ...
                stopAtCheckPointOnSource_(checkpoint_on_source,pveh,ptac,ptrajectory),
                stopAtCheckPointOnTarget_(checkpoint_on_target,pveh,ptac,ptrajectory),
                ...
                laneChangeIntoGapReference_(lcv,pveh,plat)                
        {
