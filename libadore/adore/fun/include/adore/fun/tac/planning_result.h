...
namespace adore
{
    namespace fun
    {
        ...
        struct PlanningResult
        {
            ...
            SetPointRequest nominal_maneuver;           /**< the nominal maneuver optimzed towards horizon: not to be executed but rather for HMI and decision making*/
            ...
            adore::mad::OccupancyCylinderTree nominal_maneuver_swath;/**< space-time volume expected to be covered by nominal_maneuver*/
            adore::mad::OccupancyCylinderTree combined_maneuver_swath;/**< space-time volume expected to be covered by combined_maneuver*/
            bool nominal_maneuver_valid;                    
            bool combined_maneuver_valid;               
            std::string status_string;                  /**< string explaining for example why constraint evaluation failed, e.g. "collision with prediction of object 17, branch 3, at t=0.58" or "I/O lin inversion fail"*/
            std::unordered_map<std::string,double> objective_values;     /**< set of individual objective values, to be weighted by decision making. e.g. acceleration, jerk, time-loss/navigation-cost*/
            ...
            PlanningResult()
            : nominal_maneuver_valid(false),combined_maneuver_valid(false),iteration(0),indicator_left(false),indicator_right(false){}
        };
