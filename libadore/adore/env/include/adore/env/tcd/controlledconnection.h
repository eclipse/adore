            ...
            public:
                ...
                adore::view::LimitLine::EState convert(ConnectionState::EConnectionState s)
                {
                    switch(s)
                    {
                        ...
                        case ConnectionState::DARK:
                            return adore::view::LimitLine::UNKNOWN; 
                        case ConnectionState::STOP___THEN___PROCEED:
                            return adore::view::LimitLine::STOP;
                        case ConnectionState::STOP___AND___REMAIN:
                            return adore::view::LimitLine::WAIT;
                        case ConnectionState::PRE___MOVEMENT:
                            return adore::view::LimitLine::WAIT;
                        case ConnectionState::PERMISSIVE___MOVEMENT___ALLOWED:
                            return adore::view::LimitLine::GO;
                        case ConnectionState::PROTECTED___MOVEMENT___ALLOWED:
                            return adore::view::LimitLine::CONFLICT;
                        case ConnectionState::PERMISSIVE__CLEARANCE:
                            return adore::view::LimitLine::CLEAR;
                        case ConnectionState::PROTECTED__CLEARANCE:
                            return adore::view::LimitLine::CLEAR;
                        case ConnectionState::CAUTION___CONFLICTING___TRAFFIC:
                            return adore::view::LimitLine::CONFLICT;
                        default:
                            return adore::view::LimitLine::UNKNOWN;
                    }
