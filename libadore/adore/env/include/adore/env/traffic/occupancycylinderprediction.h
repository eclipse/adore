...
namespace adore
{
    namespace env
    {
        ...
        class OCPredictionStrategy
        {
             ...
             */
            virtual void predict(const traffic::Participant& p, OccupancyCylinderPredictionSet& set)const =0;
        };
        /**
         ...
         */
        class OCStraightLinePrediction:public OCPredictionStrategy
        {
            private:
            ...
            OCStraightLinePrediction():t_max_utc_(0.0),lat_precision_(0.1),lat_error_(0.0),lon_error_(0.0),v_max_(9999.9),a_max_(0.0),a_min_(0.0),time_headway_(2.0),time_leeway_(1.0){}
            virtual void predict(const traffic::Participant& p, OccupancyCylinderPredictionSet& set)const override
            {
                double width;
                double length;
                double psi;
