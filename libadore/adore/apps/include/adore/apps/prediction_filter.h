    ...
    namespace apps
    {
        ...
        class PredictionFilter
        {
            private:
                ...
                adore::env::AFactory::TOCPredictionSetReader* prediction_reader_;/**< input predictions*/
                adore::env::AFactory::TOCPredictionSetWriter* prediction_writer_;/**< output predictions*/
            ...
            {
                prediction_reader_ = EnvFactory::get()->getExpectedRawPredictionSetReader();
                prediction_writer_ = EnvFactory::get()->getExpectedPredictionSetWriter();
            ...
            void run()
            {
                roadmap_.update();
                three_lanes_.update();
                if(prediction_reader_->hasUpdate() && motion_state_reader_->hasData())
                {
                    ...
                    prediction_reader_->getData(predictionInputSet);//read the input set
                    ...
                    prediction_writer_->write(predictionOutputSet);
                }
            }            
        };
