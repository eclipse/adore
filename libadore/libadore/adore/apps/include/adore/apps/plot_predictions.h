    ...
    class PlotPredictions
    {
      ...
      void run()
      {
        ...
        if(config_.worst_case_.active_ and worst_case_prediction_reader_->hasUpdate())
        {
          ...
          PLOT::plotPredictionSet(worst_case_predictions_,t_,t_prediction_max_,config_.worst_case_,tag.str(),figure_,plot_tags_current_worstcase_);
        ...
        if(config_.expected_.active_ and expected_prediction_reader_->hasUpdate())
        {
          ...
          PLOT::plotPredictionSet(expected_predictions_,t_,t_prediction_max_,config_.expected_,tag.str(),figure_,plot_tags_current_expected_);
        ...
        if(config_.desired_.active_ and desired_prediction_reader_->hasUpdate())
        {
          ...
          PLOT::plotPredictionSet(desired_predictions_,t_,t_prediction_max_,config_.expected_,tag.str(),figure_,plot_tags_current_desired_);
