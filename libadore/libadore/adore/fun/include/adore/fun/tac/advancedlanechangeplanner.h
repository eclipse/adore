...
namespace adore
{
  namespace fun
  {
     ...
     * Front vehicle may be overtaken.
     * Specialization of DecoupledLFLCPlanner for lane change maneuver planning.
     */
    template<int K,int P>
    class AdvancedLaneChangePlanner:public DecoupledLFLCPlanner<K,P>
    {
      private:
        LaneChangePhaseEstimator phaseEstimator_;      /**< estimates phase of a lane change maneuver */
        ...
        FollowPrecedingVehicleOnLaneToBeLeft_BrakingCurve followPrecedingVehicleOnSource_;/**< constraint enforcing vehicle to follow next vehicle on source lane*/
        ...
        AdvancedLateralOffsetConstraintLC lateralOffsetConstraint_left_;/**< constraint for staying in lane boundaries, which are selected according to gap state*/
        AdvancedLateralOffsetConstraintLC lateralOffsetConstraint_right_;/**< constraint for staying in lane boundaries, which are selected according to gap state*/
      ...
      public:
         ...
         */
        AdvancedLaneChangePlanner(   adore::view::ALaneChangeView* lcv,
              ...
              : DecoupledLFLCPlanner<K,P>(lcv->getTargetLane(),plon,plat,pveh,ptrajectory),
                phaseEstimator_(lcv,pveh,plat,ptrajectory,ptac),
                ...
                followPrecedingVehicleOnSource_(lcv->getSourceLane(),&phaseEstimator_,pveh,ptac,ptrajectory),
                ...
                lateralOffsetConstraint_left_(lcv,&phaseEstimator_,pveh,plat,ANominalConstraint::UB),
                lateralOffsetConstraint_right_(lcv,&phaseEstimator_,pveh,plat,ANominalConstraint::LB),
                laneChangeIntoGapReference_(lcv,pveh,plat,lateral_i_grid)
        {
          ...
          this->info_.add(&phaseEstimator_);
        }
