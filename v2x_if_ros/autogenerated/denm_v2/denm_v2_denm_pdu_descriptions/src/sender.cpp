...
public:
    ...
    ~SenderNode() {
        delete udp_sender;
        delete sender_denm_v2_denm_pdu_descriptions;
    }
    ...
    void run() {
        ...
        // Modules
        sender_denm_v2_denm_pdu_descriptions = new wind::wind_ros::Sender_denm_v2_denm_pdu_descriptions(udp_sender);
        sender_denm_v2_denm_pdu_descriptions->output_ip   = output_ip;
        sender_denm_v2_denm_pdu_descriptions->output_port = output_port;
        sender_denm_v2_denm_pdu_descriptions->topic       = topic;
        sender_denm_v2_denm_pdu_descriptions->start();
...
private:
    ...
    // Modules
    wind::wind_ros::Sender_denm_v2_denm_pdu_descriptions* sender_denm_v2_denm_pdu_descriptions;
};
