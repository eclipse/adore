 ...
 *
 */
#ifndef DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_ENCODER
#define DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_ENCODER
...
namespace wind
{
    namespace wind_ros
    {
        int encode(const denm_v2_denm_pdu_descriptions::DENM::ConstPtr& ros, const char *buffer);
    }
}

#endif //DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_ENCODER
