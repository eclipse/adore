 ...
 *
 */
#ifndef DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_DECODER
#define DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_DECODER
...
namespace wind
{
    namespace wind_ros
    {
        void decode(denm_v2_denm_pdu_descriptions::DENM* ros, const char *buffer);
    }
}

#endif //DENM_V2_DENM_PDU_DESCRIPTIONS_RSERIAL_DECODER
