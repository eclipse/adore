...
#ifndef DENM_V2_DENM_PDU_DESCRIPTIONS_SENDER_H
#define DENM_V2_DENM_PDU_DESCRIPTIONS_SENDER_H

#include <ros/ros.h>
#include <udp_sender.h>
#include <denm_v2_denm_pdu_descriptions/DENM.h>   // ROS message
...
class Sender_denm_v2_denm_pdu_descriptions
{
private:
    std::string            name;
...
public:
    Sender_denm_v2_denm_pdu_descriptions(wind::comm::UDPSender* udp_sender);
    ~Sender_denm_v2_denm_pdu_descriptions() {delete buff;};
    ...
    void start();
    void callback(const denm_v2_denm_pdu_descriptions::DENM::ConstPtr& msg);
    void callbackMirror(const denm_v2_denm_pdu_descriptions::DENM::ConstPtr& msg);
};

} // Closing namespace ros
} // Closing namespace wind

#endif //DENM_V2_DENM_PDU_DESCRIPTIONS_SENDER_H
