...
#ifndef DENM_V2_DENM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
#define DENM_V2_DENM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
...
namespace wind
{
    namespace wind_ros
    {
        void ros2wind(const denm_v2_denm_pdu_descriptions::DENM::ConstPtr& ros, wind::cpp::DENM_PDU_Descriptions::DENM* wind);
    }
}

#endif //DENM_V2_DENM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
