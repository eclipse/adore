...
// Nodes names
#define RECEIVER_NODE_NAME       "mcm_dmove_mcm_dmove_receiver"
#define SENDER_NODE_NAME         "mcm_dmove_mcm_dmove_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "MCM_in"
#define SENDER_ROS_TOPIC          "MCM_out"
