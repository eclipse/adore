...
#ifndef MCM_DMOVE_MCM_DMOVE_TRANSLATOR_WIND2ROS
#define MCM_DMOVE_MCM_DMOVE_TRANSLATOR_WIND2ROS
...
namespace wind
{
    namespace wind_ros
    {
        void wind2ros(mcm_dmove_mcm_dmove::MCM* ros, wind::cpp::MCM_DMove::MCM* wind);
    }
}

#endif //MCM_DMOVE_MCM_DMOVE_TRANSLATOR_WIND2ROS
