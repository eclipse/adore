...
#ifndef DSRC_V2_MAPEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
#define DSRC_V2_MAPEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
...
namespace wind
{
    namespace wind_ros
    {
        void wind2ros(dsrc_v2_mapem_pdu_descriptions::MAPEM* ros, wind::cpp::MAPEM_PDU_Descriptions::MAPEM* wind);
    }
}

#endif //DSRC_V2_MAPEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
