...
#include <dsrc_v2_spatem_pdu_descriptions/SPATEM.h>   // From ROS
...
public:
    Sender_dsrc_v2_spatem_pdu_descriptions(wind::comm::UDPSender* udp_sender);
    ...
    void start();
    void callback(const dsrc_v2_spatem_pdu_descriptions::SPATEM::ConstPtr& msg);
    void mirrorCallback(const dsrc_v2_spatem_pdu_descriptions::SPATEM::ConstPtr& msg);
};
