...
#ifndef DSRC_V2_SPATEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
#define DSRC_V2_SPATEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
...
namespace wind
{
    namespace wind_ros
    {
        void wind2ros(dsrc_v2_spatem_pdu_descriptions::SPATEM* ros, wind::cpp::SPATEM_PDU_Descriptions::SPATEM* wind);
    }
}

#endif //DSRC_V2_SPATEM_PDU_DESCRIPTIONS_TRANSLATOR_WIND2ROS
