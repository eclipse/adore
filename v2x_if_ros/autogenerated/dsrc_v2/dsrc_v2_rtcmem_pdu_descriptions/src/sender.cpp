...
public:
    ...
    ~SenderNode() {
        delete udp_sender;
        delete sender_dsrc_v2_rtcmem_pdu_descriptions;
    }
    ...
    void run() {
        ...
        // Modules
        sender_dsrc_v2_rtcmem_pdu_descriptions = new wind::wind_ros::Sender_dsrc_v2_rtcmem_pdu_descriptions(udp_sender);
        sender_dsrc_v2_rtcmem_pdu_descriptions->output_ip   = output_ip;
        sender_dsrc_v2_rtcmem_pdu_descriptions->output_port = output_port;
        sender_dsrc_v2_rtcmem_pdu_descriptions->topic       = topic;
        sender_dsrc_v2_rtcmem_pdu_descriptions->start();
...
private:
    ...
    // Modules
    wind::wind_ros::Sender_dsrc_v2_rtcmem_pdu_descriptions* sender_dsrc_v2_rtcmem_pdu_descriptions;
};
