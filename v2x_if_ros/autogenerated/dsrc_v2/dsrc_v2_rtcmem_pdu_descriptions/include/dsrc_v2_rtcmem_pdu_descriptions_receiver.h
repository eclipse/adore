 ...
 * 
 */
#ifndef DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_RECEIVER_H
#define DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_RECEIVER_H

// File name: dsrc_v2_rtcmem_pdu_descriptions_receiver.h

#include <ros/ros.h>
#include <wind_constants.h>
#include <dsrc_v2_rtcmem_pdu_descriptions/RTCMEM.h>
...
namespace wind_ros
{
    class Receiver_dsrc_v2_rtcmem_pdu_descriptions
    {
    public:
        Receiver_dsrc_v2_rtcmem_pdu_descriptions();
...
#endif //DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_RECEIVER_H
