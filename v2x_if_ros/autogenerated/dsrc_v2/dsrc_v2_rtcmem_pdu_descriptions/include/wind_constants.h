...
// Names
#define RECEIVER_NODE_NAME dsrc_v2_rtcmem_pdu_descriptions_receiver
#define SENDER_NODE_NAME   dsrc_v2_rtcmem_pdu_descriptions_sender

// Topics
#define RECEIVER_ROS_TOPIC "RTCMEM_in"
#define SENDER_ROS_TOPIC   "RTCMEM_out"
