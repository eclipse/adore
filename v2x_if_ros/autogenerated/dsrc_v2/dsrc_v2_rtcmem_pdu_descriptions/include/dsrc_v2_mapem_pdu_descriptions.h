 ...
 *
 */
#ifndef DSRC_V2_MAPEM_PDU_DESCRIPTIONS_H
#define DSRC_V2_MAPEM_PDU_DESCRIPTIONS_H
...
namespace wind
{
    namespace cpp
    {
        namespace MAPEM_PDU_Descriptions
        {
            /*
             *
            ...
            struct MAPEM
            {
                ...
                DSRC::MapData               map; // 60262
            };
            #pragma pack(pop)

        }  // Closing namespace MAPEM_PDU_Descriptions
    }  // Closing namespace cpp
}  // Closing namespace wind

#endif //DSRC_V2_MAPEM_PDU_DESCRIPTIONS_H
