...
#ifndef DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
#define DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
...
namespace wind
{
    namespace wind_ros
    {
        void ros2wind(const dsrc_v2_rtcmem_pdu_descriptions::RTCMEM::ConstPtr& ros, wind::cpp::RTCMEM_PDU_Descriptions::RTCMEM* wind);
    }
}

#endif //DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_TRANSLATOR_ROS2WIND
