...
// Nodes names
#define RECEIVER_NODE_NAME       "odds_oddinfo_receiver"
#define SENDER_NODE_NAME         "odds_oddinfo_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "ODDMSG_in"
#define SENDER_ROS_TOPIC          "ODDMSG_out"
