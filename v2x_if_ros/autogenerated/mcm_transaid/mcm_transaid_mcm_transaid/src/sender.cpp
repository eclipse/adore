...
public:
    ...
    ~SenderNode() {
        delete udp_sender;
        delete sender_mcm_transaid_mcm_transaid;
    }
    ...
    void run() {
        ...
        // Modules
        sender_mcm_transaid_mcm_transaid = new wind::wind_ros::Sender_mcm_transaid_mcm_transaid(udp_sender);
        sender_mcm_transaid_mcm_transaid->output_ip   = output_ip;
        sender_mcm_transaid_mcm_transaid->output_port = output_port;
        sender_mcm_transaid_mcm_transaid->topic       = topic;
        sender_mcm_transaid_mcm_transaid->start();
...
private:
    ...
    // Modules
    wind::wind_ros::Sender_mcm_transaid_mcm_transaid* sender_mcm_transaid_mcm_transaid;
};
