 ...
 *
 */
#ifndef DSRC_V2_SPATEM_PDU_DESCRIPTIONS_H
#define DSRC_V2_SPATEM_PDU_DESCRIPTIONS_H
...
namespace wind
{
    namespace cpp
    {
        namespace SPATEM_PDU_Descriptions
        {
            /*
             *
            ...
            struct SPATEM
            {
                ...
                DSRC::SPAT                  spat; // 15209
            };
            #pragma pack(pop)

        }  // Closing namespace SPATEM_PDU_Descriptions
    }  // Closing namespace cpp
}  // Closing namespace wind

#endif //DSRC_V2_SPATEM_PDU_DESCRIPTIONS_H
