 ...
 *
 */
#ifndef DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_H
#define DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_H
...
namespace wind
{
    namespace cpp
    {
        namespace RTCMEM_PDU_Descriptions
        {
            /*
             *
            ...
            struct RTCMEM
            {
                ...
                DSRC::RTCMcorrections       rtcmc; // 5213
            };
            #pragma pack(pop)

        }  // Closing namespace RTCMEM_PDU_Descriptions
    }  // Closing namespace cpp
}  // Closing namespace wind

#endif //DSRC_V2_RTCMEM_PDU_DESCRIPTIONS_H
