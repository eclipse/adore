 ...
 *
 */
#ifndef DSRC_V2_SREM_PDU_DESCRIPTIONS_H
#define DSRC_V2_SREM_PDU_DESCRIPTIONS_H
...
namespace wind
{
    namespace cpp
    {
        namespace SREM_PDU_Descriptions
        {
            /*
             *
            ...
            struct SREM
            {
                ...
                DSRC::SignalRequestMessage  srm; // 933
            };
            #pragma pack(pop)

        }  // Closing namespace SREM_PDU_Descriptions
    }  // Closing namespace cpp
}  // Closing namespace wind

#endif //DSRC_V2_SREM_PDU_DESCRIPTIONS_H
