...
public:
    ...
    ~SenderNode() {
        delete udp_sender;
        delete sender_cpm_v1_19_cpm_pdu_descriptions;
    }
    ...
    void run() {
        ...
        // Modules
        sender_cpm_v1_19_cpm_pdu_descriptions = new wind::wind_ros::Sender_cpm_v1_19_cpm_pdu_descriptions(udp_sender);
        sender_cpm_v1_19_cpm_pdu_descriptions->output_ip   = output_ip;
        sender_cpm_v1_19_cpm_pdu_descriptions->output_port = output_port;
        sender_cpm_v1_19_cpm_pdu_descriptions->topic       = topic;
        sender_cpm_v1_19_cpm_pdu_descriptions->start();
...
private:
    ...
    // Modules
    wind::wind_ros::Sender_cpm_v1_19_cpm_pdu_descriptions* sender_cpm_v1_19_cpm_pdu_descriptions;
};
