...
void wind::wind_ros::wind2ros(cpm_v1_19_cpm_pdu_descriptions::CPM* ros, wind::cpp::CPM_PDU_Descriptions::CPM* wind)
{
    ...
    if(ros->cpm.cpmParameters.perceptionDataPresent) {
        ...
        for(int a = 0; a < count_a; a++) {
            cpm_v1_19_cpm_pdu_descriptions::CpmPerceptionDataContainer tmp_a;
            ros->cpm.cpmParameters.perceptionData.elements.push_back(tmp_a);

            // START CHOICE CpmPerceptionDataContainer
            ros->cpm.cpmParameters.perceptionData.elements[a].choice = wind->cpm.cpmParameters.perceptionData.elements[a].choice;
            ...
            if(ros->cpm.cpmParameters.perceptionData.elements[a].choice == 0) {
                ...
                for(int b = 0; b < count_b; b++) {
                    cpm_v1_19_cpm_sensorinformation_descriptions::SensorInformation tmp_b;
                    ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements.push_back(tmp_b);
                    ...
                    ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice;
                    ...
                    if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice == 0) {
                        ...
                        for(int c = 0; c < count_c; c++) {
                            cpm_v1_19_cpm_sensorinformation_descriptions::VehicleSensorProperties tmp_c;
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.vehicleSensor.vehicleSensorPropertyList.elements.push_back(tmp_c);
                    ...
                    else if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice == 1)  // CHOICE DetectionArea
                    {
                        ...
                        if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffsetPresent) {
                            ...
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffset.nodeOffsetPointxy.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffset.nodeOffsetPointxy.choice;
                            ...
                            if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffset.nodeOffsetPointZPresent) {
                                ...
                                ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffset.nodeOffsetPointZ.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRadial.sensorPositionOffset.nodeOffsetPointZ.choice;
                    ...
                    else if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice == 2)  // CHOICE DetectionArea
                    {
                        ...
                        for(int d = 0; d < count_d; d++) {
                            cpm_v1_19_cpm_commondatatypes_descriptions::OffsetPoint tmp_d;
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements.push_back(tmp_d);
                            ...
                            // START CHOICE NodeOffsetPointXY
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements[d].nodeOffsetPointxy.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements[d].nodeOffsetPointxy.choice;
                            ...
                            if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements[d].nodeOffsetPointZPresent) {
                                ...
                                // START CHOICE NodeOffsetPointZ
                                ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements[d].nodeOffsetPointZ.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorPolygon.polyPointList.elements[d].nodeOffsetPointZ.choice;
                    ...
                    else if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice == 3)  // CHOICE DetectionArea
                    {
                        ...
                        if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPointPresent) {
                            ...
                            // START CHOICE NodeOffsetPointXY
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPoint.nodeOffsetPointxy.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPoint.nodeOffsetPointxy.choice;
                            ...
                            if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPoint.nodeOffsetPointZPresent) {
                                ...
                                // START CHOICE NodeOffsetPointZ
                                ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPoint.nodeOffsetPointZ.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorCircular.nodeCenterPoint.nodeOffsetPointZ.choice;
                    ...
                    else if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.choice == 4)  // CHOICE DetectionArea
                    {
                        ...
                        if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPointPresent) {
                            ...
                            // START CHOICE NodeOffsetPointXY
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPoint.nodeOffsetPointxy.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPoint.nodeOffsetPointxy.choice;
                            ...
                            if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPoint.nodeOffsetPointZPresent) {
                                ...
                                // START CHOICE NodeOffsetPointZ
                                ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPoint.nodeOffsetPointZ.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorEllipse.nodeCenterPoint.nodeOffsetPointZ.choice;
                    ...
                    else   // CHOICE DetectionArea
                    {
                        ...
                        if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPointPresent) {
                            ...
                            // START CHOICE NodeOffsetPointXY
                            ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPoint.nodeOffsetPointxy.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPoint.nodeOffsetPointxy.choice;
                            ...
                            if(ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPoint.nodeOffsetPointZPresent) {
                                ...
                                // START CHOICE NodeOffsetPointZ
                                ros->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPoint.nodeOffsetPointZ.choice = wind->cpm.cpmParameters.perceptionData.elements[a].sensorInformationContainer.elements[b].detectionArea.stationarySensorRectangle.nodeCenterPoint.nodeOffsetPointZ.choice;
            ...
            else   // CHOICE CpmPerceptionDataContainer
            {
                ...
                for(int e = 0; e < count_e; e++) {
                    cpm_v1_19_cpm_perceivedobject_descriptions::PerceivedObject tmp_e;
                    ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements.push_back(tmp_e);
                    ...
                    if(ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].sensorIDListPresent) {
                        ...
                        for(int f = 0; f < count_f; f++) {
                            cpm_v1_19_cpm_commondatatypes_descriptions::Identifier tmp_f;
                            ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].sensorIDList.elements.push_back(tmp_f);
                    ...
                    if(ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].classificationPresent) {
                        ...
                        for(int g = 0; g < count_g; g++) {
                            cpm_v1_19_cpm_commondatatypes_descriptions::ObjectClassWithConfidence tmp_g;
                            ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].classification.elements.push_back(tmp_g);

                            // START CHOICE ObjectClass
                            ros->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].classification.elements[g].objectClass.choice = wind->cpm.cpmParameters.perceptionData.elements[a].perceivedObjectContainer.perceivedObjects.elements[e].classification.elements[g].objectClass.choice;
