...
public:
    ...
    ~ReceiverNode() {
        delete udp_receiver;
        delete receiver_cam_v2_cam_pdu_descriptions;
    }
    ...
    void receiveMsgCallback(const void* buf, const size_t& buf_size)
    {
        ...
        if(buf_size == receiver_cam_v2_cam_pdu_descriptions->message_id()) {
            receiver_cam_v2_cam_pdu_descriptions->incoming_message(buf);
        }
        else {
    ...
    void run()
    {
        ...
        receiver_cam_v2_cam_pdu_descriptions = new wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions();
        ROS_INFO_STREAM("Registering message name(" << receiver_cam_v2_cam_pdu_descriptions->message_name() 
            << ") id(" << receiver_cam_v2_cam_pdu_descriptions->message_id() << ")");
        receiver_cam_v2_cam_pdu_descriptions->set_topic(topic);
        receiver_cam_v2_cam_pdu_descriptions->start();
...
private:
    ...
    wind::wind_ros::Receiver_cam_v2_cam_pdu_descriptions* receiver_cam_v2_cam_pdu_descriptions;
};
