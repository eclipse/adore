...
void wind::wind_ros::ros2wind(const cam_v2_cam_pdu_descriptions::CAM::ConstPtr& ros, wind::cpp::CAM_PDU_Descriptions::CAM* wind)
{
    ...
    wind->cam.camParameters.highFrequencyContainer.choice = ros->cam.camParameters.highFrequencyContainer.choice;
    ...
    if(ros->cam.camParameters.lowFrequencyContainerPresent) {
        ...
        wind->cam.camParameters.lowFrequencyContainer.choice = ros->cam.camParameters.lowFrequencyContainer.choice;
    ...
    if(ros->cam.camParameters.specialVehicleContainerPresent) {
        ...
        wind->cam.camParameters.specialVehicleContainer.choice = ros->cam.camParameters.specialVehicleContainer.choice;
