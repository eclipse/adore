...
public:
    ...
    ~SenderNode() {
        delete udp_sender;
        delete sender_cam_v2_cam_pdu_descriptions;
    }
    ...
    void run() {
        ...
        // Modules
        sender_cam_v2_cam_pdu_descriptions = new wind::wind_ros::Sender_cam_v2_cam_pdu_descriptions(udp_sender);
        sender_cam_v2_cam_pdu_descriptions->output_ip   = output_ip;
        sender_cam_v2_cam_pdu_descriptions->output_port = output_port;
        sender_cam_v2_cam_pdu_descriptions->topic       = topic;
        sender_cam_v2_cam_pdu_descriptions->start();
...
private:
    ...
    // Modules
    wind::wind_ros::Sender_cam_v2_cam_pdu_descriptions* sender_cam_v2_cam_pdu_descriptions;
};
