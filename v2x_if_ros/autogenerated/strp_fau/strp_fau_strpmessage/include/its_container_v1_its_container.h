 ...
 *
 */
#ifndef ITS_CONTAINER_V1_ITS_CONTAINER_H
#define ITS_CONTAINER_V1_ITS_CONTAINER_H
    ...
    namespace cpp
    {
        namespace ITS_Container
        {
            ...
            struct SemiAxisLength
            {
                ...
                static constexpr int16_t OUT_OF_RANGE = 4094;
                static constexpr int16_t UNAVAILABLE  = 4095;
            ...
            {
                SemiAxisLength semiMajorConfidence; // 2
                SemiAxisLength semiMinorConfidence; // 2
            ...
            {
                static constexpr int16_t MIN         = -30000;
                static constexpr int16_t MAX         = 30001;
                static constexpr int16_t UNAVAILABLE = 30001;
            ...
            {
                static constexpr float MIN          = 0;
                static constexpr float MAX          = 10.2;
                static constexpr float OUT_OF_RANGE = 10.1;
                static constexpr float UNAVAILABLE  = 10.2;
                static constexpr int32_t SCALEDIVISOR = 10;
            ...
            struct ReferencePosition
            {
                ...
                PosConfidenceEllipse positionConfidenceEllipse; // 8
                Altitude             altitude; // 5
            };
            #pragma pack(pop)
             ...
             */
            #pragma pack(push, 1)
            struct DangerousGoodsExtended_phoneNumber
            {
                static constexpr int32_t MIN        = 1;
                static constexpr int32_t MAX        = 24;
            ...
            /*
             *
             * Denotes rotation around the center of mass of the empty vehicle.
             * 
             * Element type: REAL
             * Size: 4 bytes.
             *
            ...
            struct PosPillar
            {
                ...
                static constexpr int8_t UNAVAILABLE = 30;
            ...
            {
                static constexpr int8_t MIN         = 1;
                static constexpr int8_t MAX         = 20;
                static constexpr int8_t UNAVAILABLE = 20;
            ...
            struct HeightLonCarr
            {
                ...
                static constexpr int8_t UNAVAILABLE = 100;
            ...
            struct ItineraryPath
            {
                ...
                int8_t            count; // 1161
                ReferencePosition elements[40]; // 29
            };
            #pragma pack(pop)
            ...
            {
                bool                                       emergencyActionCodePresent; // 81
                bool                                       phoneNumberPresent; // 81
                bool                                       companyNamePresent; // 81
                ...
                DangerousGoodsExtended_phoneNumber         phoneNumber; // 24
            ...
            struct ClosedLanes
            {
                bool               hardShoulderStatusPresent; // 16
                HardShoulderStatus hardShoulderStatus; // 1
                DrivingLaneStatus  drivingLaneStatus; // 14
            };
            #pragma pack(pop)
            ...
            struct PosCentMass
            {
                ...
                static constexpr int8_t UNAVAILABLE = 63;
...
#endif //ITS_CONTAINER_V1_ITS_CONTAINER_H
