...
void wind::wind_ros::wind2ros(strp_fau_strpmessage::SpaceTimeReservationProcedure* ros, wind::cpp::STRPMessage::SpaceTimeReservationProcedure* wind)
{
    ...
    ros->data.choice = wind->data.choice;
    ...
    if(ros->data.choice == 0) {
        ...
        ros->data.request.reservation.choice = wind->data.request.reservation.choice;
