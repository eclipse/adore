        ...
        */
        ...
        public:
            ...
            void initSim()
            {
                ...
                if (useScheduler_)
                {
                    snm_ = new adore::sim::SchedulerNotificationManager(adore::sim::SimFactoryInstance::get(), std::hash<std::string>{}(ros::this_node::getNamespace() + ros::this_node::getName()), (uint32_t)(1e9 / rate_));
            ...
            {
                return n_->param<T>(name, val, default_val);
            }
        };
    } // namespace if_ROS
} // namespace adore
