  ...
  namespace if_ROS
  {
    namespace params
    {
      class PLongitudinalPlanner:public adore::params::APLongitudinalPlanner,ROSParam
      {
        ...
        {
          double value = 2.0;
          static const std::string name = prefix_ + "acc_ub_slow";
          get(name,value);
          return value;
        }
        ...
        {
          double value = 5.0;
          static const std::string name = prefix_ + "v_acc_ub_slow";
          get(name,value);
          return value;
        }
        ...
        {
          bool value = true;
          static const std::string name = prefix_ + "stopAtRedLights_always_before";
          get(name,value);
          return value;
        }
        ...
        {
          double value = 50.0;
          static const std::string name = prefix_ + "stopAtRedLights_max_connection_length";
          get(name,value);
          return value;
        }
        /**
        ...
        {
          double value = 5.0;
          static const std::string name = prefix_ + "stop_distance_to_conflict_point";
          get(name,value);
          return value;
        }
      };
